...
og1 <- expand.grid(cog_id = c("OG1"), ssp_id = c("9606", "9598", "9595", "9544", "9555", "10116", "10090", "9615", "9031", "9103", "8364", "7897", "7955"))
og2 <- expand.grid(cog_id = c("OG2"), ssp_id = c("9606", "9598", "9595", "9544", "9555", "10116", "9615"))
og3 <- expand.grid(cog_id = c("OG3"), ssp_id = c("9606", "9598", "9595", "13616"))
cogdata <- rbind(og1, og2, og3)
cogdata$protein_id <- paste0(cogdata$ssp_id, ".", cogdata$cog_id)
```
...
species <- read.csv("sample_species.txt")
phyloTree <- make.phyloTree(sspids = species$taxid)
